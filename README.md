...
Model: Fine-tuned meta-llama/Llama-3.1-8B for generating accurate medical responses.
...
Backend: Deployed on Render for reliable API handling.

Project Contributions

Muhammad Abdullah Butt (2021-CS-81)  🚀

Designed and implemented the backend, model training, deployment, and Git management.

Worked on Kaggle for model training and collected dataset.

Fine-tuned Llama-3.1-8B and optimized RAG-based retrieval.

Deployed backend on Render and frontend on Vercel, managed Firebase database.
